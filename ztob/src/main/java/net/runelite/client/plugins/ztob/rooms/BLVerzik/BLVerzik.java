...
public class BLVerzik extends BLRoom
{
	enum Phase
	{
		PHASE1,
	...
	@Inject
	private BLVerzikOverlay verzikOverlay;
	...
	@Inject
	private BLVerzik(BLTheatrePlugin plugin, BLTheatreConfig config)
	{
		super(plugin, config);
	}
	...
	Color verzikSpecialWarningColor()
	{
		...
		{
			case BLVerzik.p3_crab_attack_count - 1:
				col = Color.MAGENTA;
				break;
			case BLVerzik.p3_web_attack_count - 1:
				col = Color.ORANGE;
				break;
			case BLVerzik.p3_yellow_attack_count - 1:
				col = Color.YELLOW;
				break;
			case BLVerzik.p3_green_attack_count - 1:
				col = Color.GREEN;
				break;
		}
		return col;
