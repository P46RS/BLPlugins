...
public class BLBloat extends BLRoom
{
	...
	@Inject
	private BLBloatOverlay BLBloatOverlay;
	@Inject
	private Client client;

	@Inject
	protected BLBloat(BLTheatrePlugin plugin, BLTheatreConfig config)
	{
		super(plugin, config);
	}
	...
	public void load()
	{
		overlayManager.add(BLBloatOverlay);
	}

	@Override
	public void unload()
	{
		overlayManager.remove(BLBloatOverlay);
	...
	Polygon getBloatTilePoly()
	{
		...
		switch (bloatState)
		{
			case 1:
				...
				return BLRoomOverlay.getCanvasTileAreaPoly(client, lp, size, true);
			case 2:
			case 3:
				...
				return BLRoomOverlay.getCanvasTileAreaPoly(client, lp, size, false);
		}
