...
public class BLMaiden extends BLRoom
{
	@Inject
	private Client client;
	@Inject
	private BLMaidenOverlay BLMaidenOverlay;
	@Inject
	protected BLMaiden(BLTheatrePlugin plugin, BLTheatreConfig config)
	{
		super(plugin, config);
	}
	...
	public void load()
	{
		overlayManager.add(BLMaidenOverlay);
	}

	@Override
	public void unload()
	{
		overlayManager.remove(BLMaidenOverlay);
