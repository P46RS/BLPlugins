...
import net.runelite.client.plugins.ztob.rooms.BLNylocas.BLNylocasWave;
...
public class BLNylocasAliveCounterOverlay extends Overlay
{
	...
	@Inject
	private BLNylocasAliveCounterOverlay(BLTheatreConfig config)
	{
		this.config = config;
	...
	private void refreshPanel()
	{
		...
		waveComponent = LineComponent.builder().left("Wave " + wave + "/" + BLNylocasWave.MAX_WAVE).build();
