...
public class BLVerzikOverlay extends BLRoomOverlay
{
	...
	@Inject
	protected BLVerzikOverlay(BLTheatreConfig config)
	{
		super(config);
	}
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		{
			String text = "";
			if (config.verzikWheelchairMode2() && verzik.getVerzikSpecial() != BLVerzik.SpecialAttack.WEBS)
			{
			...
			if (config.verzikWheelchairMode1() && verzik.getVerzikSpecial() != BLVerzik.SpecialAttack.WEBS)
			{
