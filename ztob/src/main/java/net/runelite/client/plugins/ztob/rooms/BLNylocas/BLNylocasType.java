...
enum BLNylocasType
{
	...
	@Getter
	private static final HashMap<Integer, BLNylocasType> lookupMap;
	static
	{
		lookupMap = new HashMap<>();
		for (BLNylocasType v : BLNylocasType.values())
		{
	...
	BLNylocasType(int id, int id_sm, int id_hm, int aggroId, int aggroId_sm, int aggroId_hm)
	{
		this.id = id;
		this.id_sm = id_sm;
		this.id_hm = id_hm;
