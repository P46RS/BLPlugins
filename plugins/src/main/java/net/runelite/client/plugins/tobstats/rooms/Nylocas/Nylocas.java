...
public class Nylocas extends Room
{
    ...
    protected void startTimer()
    {
        ...
        if (!active)
        {
            net.runelite.client.plugins.ztob.rooms.BLNylocas.Nylocas.setWave31Callback(() ->
            {
            ...
            net.runelite.client.plugins.ztob.rooms.BLNylocas.Nylocas.setEndOfWavesCallback(() ->
            {
                int millis = getCurrentMillis();
    ...
    protected void reset()
    {
        ...
        net.runelite.client.plugins.ztob.rooms.BLNylocas.Nylocas.setEndOfWavesCallback(null);
        net.runelite.client.plugins.ztob.rooms.BLNylocas.Nylocas.setWave31Callback(null);
